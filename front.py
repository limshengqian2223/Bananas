...
def view_by_activity():
    ...
    if dict(request.args) == {}:
        return render_template('view_info.html',
                              ...
                              form_meta={'action':'/view_by_activity',
                                        'method':'get'},
                              form_data={'activity_name':''},
                              error=None)
    ...
    if request.method == 'GET':
        ...
        if 'registered' in request.args:
            ...
            if status:
                ...
                # new class doesnt exist. autofill to original state
                # command directly below is to re-obtain the original student class.
                record["student_class"] = sc.find_by_name(record["student_name"])["class"]
                print(record)
                return render_template('edit_info.html',
                              ...
                              form_meta={'action':'/edit_student?registered',
                                  ...
                                  form_data={
                                      ...
                                      "student_year_enrolled": record["student_year_enrolled"],
                                      "student_grad_year": record["student_grad_year"]
                                  },
            ...
            return render_template('edit_info.html',
                              ...
                              form_meta={'action':'/edit_student?registered',
                                  ...
                                  form_data={
                                      ...
                                      "student_age": record["age"],
                                      "student_year_enrolled": record["year enrolled"],
                                      "student_grad_year": record["graduating year"]
                                  },
...
def edit_membership():
    ...
    if request.method == 'GET':
        ...
        if 'registered' in request.args:
            ...
            status, message = sct.update(record['student_name'], record["pre_student_cca"], record)
            ...
            if status:
                ...
                return render_template('edit_info.html',
                              ...
                              form_meta={'action':'/edit_membership?registered',
                                        'method':'post'},
                                form_data={'student_name': record['student_name'],
...
def edit_participation():
    ...
    if request.method == 'GET':
        ...
        if 'registered' in request.args:
            record = dict(request.form)
            status, message = sat.update(record['student_name'], record['pre_student_activity'], record)
...
def delete_student_activity():
    if request.method == 'GET':
        ...
        if request_args != {}:
            sat.delete(request_args['student_name'], request_args['activity_name'])
            return render_template('delete_details.html',
